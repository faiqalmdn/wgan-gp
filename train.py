...
lr_scheduler = LRSheduler(decay_epochs=15, tb_callback=tb_callback, min_lr=0.00002)
...
gan.fit(train_generator, epochs=15, callbacks=[callback, tb_callback, lr_scheduler])
